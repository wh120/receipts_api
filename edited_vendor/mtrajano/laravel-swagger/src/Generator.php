...
class Generator
{
    ...
    protected function generateSecurityDefinitions()
    {
        ...
        if($authFlow == 'bearer') return $this->generateBearerSecurityDefinitions();
    ...
    protected function generateBearerSecurityDefinitions()
    {
        $authFlow = $this->config['authFlow'];
    ...
    protected function generatePath()
    {
        ...
        $tag = array_key_exists(2,$route)? $route[2]:$route[1];
    ...
    {
        if (!in_array($flow, ['password', 'application', 'implicit', 'accessCode' ,'bearer'])) {
